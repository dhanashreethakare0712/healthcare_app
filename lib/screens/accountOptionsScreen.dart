  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'My Account', style: TextStyle(fontSize: 20, color: Colors.white),),
      ),
      body: ListView(
        children: [
          Padding(
            ...
            child: Container(
              ...
              child: Center(
                child: ListTile(
                  ...
                  title: Text('Alice', style: TextStyle(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      ...
                      Container(
                        height: 60,
                        width: 60,
                        // Set width and height to create a square container
                        decoration: BoxDecoration(
                          shape: BoxShape.circle, // Set the shape to circle
                          image: DecorationImage(
                            image: AssetImage('assets/alice.jpeg'),
                            // Your image path
                      ...
                      IconButton(
                        icon: Icon(
                          ...
                          color: GlobalVariable
                              .appBarColor, // Set the icon color to red
                        ),
                        onPressed: () {
                          Navigator.push(
                            context,
              ...
              trailing: GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (_) => const HealthAndSupportScreen()),
                  );
                },
              ),
            ),
